<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            {{-- <div class="mb-10">
              <a href="{{ route('customers.create') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">+ Create User</a>
            </div> --}}
            <div class="bg-white">
                    ...
                    @if ($item->roles == 'customer')
                        <tr>
                          ...
                          <td class="border px-6 py-4 text-center">
                            <a href="{{ route('customers.show', $item->id) }}" class="iniline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mx-2 rounded">Detail</a>
                          </td>
                        </tr>
                    @endif
                  @empty
